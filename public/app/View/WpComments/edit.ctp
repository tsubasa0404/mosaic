...
<?php echo $this->Form->create('WpComment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Wp Comment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WpComment.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('WpComment.id'))); ?></li>
