<?php $this->set('title_for_layout', 'オーダー詳細'); ?>
<?php $this->Html->css('sweetalert', array('inline' => false, 'block' => 'page-css')) ?>
	<?php $this->Html->addCrumb('オーダー一覧', '/orders/order_list'); ?>
					...
					<div class="main-box-body clearfix">
						...
						<?php echo $this->Html->link('edit-link', array(
							...
							<table id="" class="table table-bordered" style="clear: both;table-layout: fixed">
								<thead>
									<tr>
										<th class="text-center"><span>納期</span></th>
										<th class="text-center"><span>モザイクタイプ</span></th>
										<th class="text-center"><span>モザイクサイズ</span></th>
										<th class="text-center"><span>受注金額</span></th>
										<th class="text-center"><span>動画の尺</span></th>
										<th class="text-center"><span>備考</span></th>
										<th class="text-center"><span>開始日時</span></th>
										<th class="text-center"><span>終了日時</span></th>
										<th class="text-center"><span>残業時間</span></th>
										<th class="text-center"><span>作業時間</span></th>
										<th class="text-center"><span>作業状況</span></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td class="text-center"><span><?php echo number_format($order['Order']['price']); ?> 円</span>
											<span class="hidden" id="order_price"><?php echo $order['Order']['price']; ?></span>
										</td>
										<td class="text-center"><span><?php echo $order['Order']['length']; ?> 分</span>
										...
										<td class="text-center"><span><?php echo $startedCompletedOvertimeWorktime[0]['sumOvertime']; ?></span> 時間</td>
										<td class="text-center"><span><?php echo number_format($startedCompletedOvertimeWorktime[0]['sumWorktime'],2); ?></span> 時間</td>
							...
							<table id="user" class="table table-hover table-bordered" style="clear: both">
								<thead>
									<tr>
										...
										<th class="text-center" colspan="2"><span>タイムコード</span></th>
										<th class="text-center"><span>編集時間</span></th>
										<th class="text-center"><span>割り当てポイント</span></th>
										<th class="text-center"><span>担当者</span></th>
										<th class="text-center"><span>開始日時</span></th>
										<th class="text-center"><span>終了日時</span></th>
										<th class="text-center"><span>残業時間</span></th>
										<th class="text-center"><span>作業時間</span></th>
								...
								<tbody>
									<?php foreach($taskRecordList as $taskRecord) : ?>
										<tr id="task_<?php echo $taskRecord['TaskRecord']['id'];?>" data-id="<?php echo $taskRecord['TaskRecord']['id'];?>">
											...
											<td class="text-center" width="7.5%"><?php echo $taskRecord['TaskRecord']['edit_length'];?> 分</td>
											...
											<td class="text-center" width="7.5%"><?php echo $taskRecord['TaskRecord']['overtime'];?> 時間</td>
											<td class="text-center" width="5%"><?php echo $taskRecord['TaskRecord']['worktime'];?> 時間</td>
