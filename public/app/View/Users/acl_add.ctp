...
<?php echo $this->Form->create('Acl'); ?>
 ...
 <?php
 echo $this->Form->input('user_role_id', array('options' => $userRolesValue));
...
<div class="actions">
 ...
 <li><?php echo $this->Html->link(__('リストUserRole'), array('controller' => 'userRoles', 'action' => 'index')); ?> </li>
 <li><?php echo $this->Html->link(__('新規UserRole'), array('controller' => 'userRoles', 'action' => 'add')); ?> </li>
