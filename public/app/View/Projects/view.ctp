...
<h2><?php echo __('Project'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($project['Project']['project']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php foreach ($project['Expense'] as $expense): ?>
		<tr>
...
<div class="related">
	...
	<?php foreach ($project['Income'] as $income): ?>
		<tr>
