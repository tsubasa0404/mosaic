...
<?php echo $this->Form->create('WpPost'); ?>
	<fieldset>
		<legend><?php echo __('Edit Wp Post'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WpPost.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('WpPost.id'))); ?></li>
