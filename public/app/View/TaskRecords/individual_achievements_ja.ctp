<?php $this->set('title_for_layout', '個人の業績'); ?>
	<?php $this->Html->addCrumb('個人の業績', '/task_records/individual_achievements/'); ?>
						<h1>個人の業績</h1>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3 col-sm-6 col-xs-12">
					<div class="main-box infographic-box">
						...
						<span class="value"><?php echo number_format($individualGoal) ?> 円</span>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<div class="main-box-body clearfix">
							<div class="tabs-wrapper">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#tab-pie" data-toggle="tab">目標達成率</a></li>
									<li><a href="#tab-graph" data-toggle="tab">業績推移グラフ</a></li>
								</ul>
								<!-- /tab menu -->
								<!-- contents -->
																	...
																	<div class="main-box clearfix project-box emerald-box">
																		<div class="main-box-body clearfix">
																			<div class="project-box-header emerald-bg">
																				<div class="name">
																					<a href="" title=""><?php	echo $val['Employee']['employee_no'];?></a>
																				</div>
																			</div>
