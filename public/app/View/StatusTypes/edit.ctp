...
<?php echo $this->Form->create('StatusType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Status Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('StatusType.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('StatusType.id'))); ?></li>
